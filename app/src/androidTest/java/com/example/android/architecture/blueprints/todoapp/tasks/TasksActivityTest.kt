...
class TasksActivityTest {
    ...
    // TODO running all tests is flaky get one of the following:
    //  java.lang.IllegalStateException: Cannot perform this operation because the connection pool has been closed.
    //  (for editTask, but only some of the time) androidx.test.espresso.NoMatchingViewException: No views in hierarchy found matching: with id: com.example.android.architecture.blueprints.reactive:id/task_detail_title_text
    //  App seems to run without editTask just fine
