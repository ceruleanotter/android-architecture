...
class TaskDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.completed.observe(this, Observer { isChecked ->
            viewDataBinding.taskDetailComplete.apply {
                this.isChecked = isChecked

                // Makes it so that the checkbox doesn't animate in when checked
